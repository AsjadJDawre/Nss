...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['reset_email'], $_SESSION['reset_otp'])) {
        ...
        if ($enteredOTP == $storedOTP) {
            ...
            $updateSql = "UPDATE admin SET password = '$hashedPassword' WHERE admin_email = '$resetEmail'";
            ...
            if ($conn->query($updateSql) === TRUE) {
                ...
                $updateotp = "UPDATE admin SET otp = NULL WHERE admin_email = '$resetEmail'";
        ...
        <div class="row align-items-center justify-content-center min-vh-100">
            <div class="col-12 col-md-8 col-lg-4">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <div class="mb-4">
                            <h5>Forgot Password?/ New Admin Registration </h5>
                            <p class="mb-2">Enter the OTP sent to your registered email ID to reset the password</p>
                        </div>
                        <form action="recover_email_admin.php" method="post">
                            <div class="mb-3">
                        ...
                        <?php
                            ...
                            if (isset($_SESSION['reset_error'])) {
                                ...
                                unset($_SESSION['reset_error']); // Reset and clear the session variable
                            }
                        ?>
                    </div>
                </div>
